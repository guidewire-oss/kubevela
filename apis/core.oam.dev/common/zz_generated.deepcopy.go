...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationSourceConsumedStatus) DeepCopyInto(out *ApplicationSourceConsumedStatus) {
	*out = *in
	if in.Value != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationSourceConsumedStatus.
func (in *ApplicationSourceConsumedStatus) DeepCopy() *ApplicationSourceConsumedStatus {
	if in == nil {
		return nil
	}
	out := new(ApplicationSourceConsumedStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ApplicationSourceStatus) DeepCopyInto(out *ApplicationSourceStatus) {
	*out = *in
	if in.Consumed != nil {
		...
		*out = make([]ApplicationSourceConsumedStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
